...
class _RadioTabState extends State<RadioTab> {
  ...
  int? playingIndex; // أي راديو شغال دلوقتي
      ...
      body: Container(
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage(AppAssets.quranBackground), // خلفية الراديو
            fit: BoxFit.cover,
          ),
        ),
        child: SafeArea(
  ...
  Widget buildTabButton(String title, int index) {
    ...
    return GestureDetector(
      onTap: () {
        setState(() {
          selectedTab = index;
          playingIndex = null; // إيقاف أي تشغيل
        });
      },
      child: Container(
  ...
  /// =============================================================
  /// نسخة جديدة من buildStationCard (المسجد + الموجات)
  /// =============================================================
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          // خلفية المسجد أو الموجات + الأزرار
          SizedBox(
            height: 50,
            child: Stack(
