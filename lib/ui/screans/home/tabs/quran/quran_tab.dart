...
class _QuranTabState extends State<QuranTab> {
  List<dynamic> filteredSurasList = AppConstants.suras; // قائمة السور المفلترة
  TextEditingController searchController =
      TextEditingController(); // كونترولر البحث
  ...
  @override
  void dispose() {
    searchController.dispose(); // تنضيف الكونترولر
    super.dispose();
  }
  ...
  Widget buildSearchTextField() {
    ...
    return Container(
      child: TextField(
        controller: searchController, // ربط الكونترولر
        onChanged: (searchKey) {
          // تشغيل البحث مع كل تغيير في النص
  ...
  Widget buildFilteredSurasListView() {
    return ListView.separated(
      ...
      itemCount: filteredSurasList.length, // استخدام القائمة المفلترة
      itemBuilder: (context, index) {
  ...
  void filterSuraListBySearchKey(String searchKey) {
    if (searchKey.isEmpty) {
      // لو البحث فاضي، ارجع كل السور
      filteredSurasList = AppConstants.suras;
    } else {
      // فلتر السور بناءً على الاسم الإنجليزي أو العربي
